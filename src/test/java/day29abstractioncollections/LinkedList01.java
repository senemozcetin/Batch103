...
public class LinkedList01 {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        visitors.removeFirstOccurrence("Tom Hanks");//tom hanks in ilk gorunumunu siler
        System.out.println(visitors);//[Tom, Hanks, Angelina Julie, Brad, Pitt, Brad Pitt, Brad Pitt, Tom Hanks]

        visitors.removeLastOccurrence("Brad Pitt");// brad pitt in son gorunumunu siler
        ...
        /*
            ...
            pop : ilk elemani verir ve listeden siler yani kes yapistir gibidir
            bos bir liste ile pop methodunu kullanirsam bana  NoSuchElementException atar.
         */
