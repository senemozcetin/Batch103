...
public class Exceptions01 {
    public static void main(String[] args) {
        ...
        int r = convertStringToInteger(st);// NumberFormatException: Eger icinde rakamdan farkli karakter barindiran bir String i
                                           //                        valueOf() kullanarak Integer a cevirmek isterseniz NumberFormatException
                                           //                        alirsiniz.
    ...
    public static int convertStringToInteger(String str){
        int i =0;
        try{
           //Herhangi bir satirda "Exception" atilirsa Java direkt "catch" bolumune gecertry icindeki sonraki kodlari calistirmaz
