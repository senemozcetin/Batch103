...
public class LinkedList01 {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            peek: ilk elemani alir ama elemani silmez, list bossa null verir exception vermez
         */
        ...
        /*
        Retrives and removes  first element of this list.
        Returns : the head of this list, or "null" if this list is empty

        poll: ilk elemani silerek verir pop gibi aralarindaki fark list bossa pop hata verir poll null verir
         */
        ...
        element: ilk elemani verir ve silmez. list bossa exception atar
         */
